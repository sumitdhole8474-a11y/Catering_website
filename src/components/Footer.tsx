  ...
  return (
    <footer className="bg-[rgb(7,9,47)] text-white pt-20 pb-8">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-12">
        ...
        >
          ...
          <div className="flex gap-4 mt-6">
            {[
              { Icon: FaFacebookF, href: "https://www.facebook.com/yourpage" },
              { Icon: FaTwitter, href: "https://twitter.com/yourprofile" },
              { Icon: FaYoutube, href: "https://www.youtube.com/@yourchannel" },
              {
                Icon: FaInstagram,
                href: "https://www.instagram.com/gurukrupasamratcateringservice",
              },
            ].map(({ Icon, href }, i) => (
              <motion.a
                key={i}
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={i} className="border-b border-white/30 pb-2">
                <Link
                  href={item.href}
                  className="hover:text-red-600 transition block cursor-pointer"
                >
                  {item.label}
                </Link>
              </li>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        custom={4}
        className="border-t border-white/30 mt-12 pt-6 flex flex-col md:flex-row justify-between text-sm px-4"
      >
